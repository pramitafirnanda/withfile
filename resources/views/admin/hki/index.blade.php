        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Hak Kekayaan Intelektual (HKI)</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ Form::open(['method' => 'post', 'route' => 'hki.store', 'class' => 'form-horizontal', 'files'=> true]) }}
                                @include('admin.hki.form')
                            {{ Form::close() }}
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="m-t-0 header-title"><b>Data Hak Kekayaan Intelektual</b></h4>
                    <table id="datatable" class="table table-bordered">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td>{{$data->judul}}</td>
                                <td>
                                    Jenis: <strong>{{$data->jenis}}</strong><br>
                                    No. Pendaftaran: {{$data->nomor}}<br>
                            ...
                            <div class="modal fade view_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['lppm-hki.show', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                            @include('lppm.hki.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{action('HkiController@destroy', $data['id'])}}" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade update_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['hki.update', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                                @include('admin.hki.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
