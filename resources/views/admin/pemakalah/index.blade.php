                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ Form::open(['method' => 'post', 'route' => 'pemakalah.store', 'class' => 'form-horizontal', 'files'=> true]) }}
                                @include('admin.pemakalah.form')
                            {{ Form::close() }}
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{action('PemakalahController@destroy', $data['id'])}}" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade update_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['pemakalah.update', $data->id], 'method'=>'PUT', 'files'=>true])}}
                                                @include('admin.pemakalah.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
