                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ Form::open(['method' => 'post', 'route' => 'kinerja-jurnal.store', 'class' => 'form-horizontal', 'files'=> true]) }}
                                @include('admin.kinerja_luaran.publikasi_jurnal.form')
                            {{ Form::close() }}
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
                    ...
                    <table id="datatable" class="table table-bordered">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td>
                                  <strong>{{$data->nama_jurnal}}</strong>
                            ...
                            <div class="modal fade view_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['lppm-kinerja-jurnal.show', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{action('KinerjaJurnalController@destroy', $data['id'])}}" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade update_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['kinerja-jurnal.update', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                                @include('admin.kinerja_luaran.publikasi_jurnal.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
