        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Luaran IPTEK lainnya</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ Form::open(['method' => 'post', 'route' => 'kinerja-iptek.store', 'class' => 'form-horizontal', 'files'=> true]) }}
                                @include('admin.kinerja_luaran.iptek.form')
                            {{ Form::close() }}
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="m-t-0 header-title"><b>Luaran IPTEK lainnya</b></h4>
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="kinerja-iptek/{{$data->dokumen}}" title="download"><i class="fa fa-download fa-lg"></i> </a>
                                        <a href="{{ asset('file_dokumen/kinerja/iptek/'.$data->dokumen) }}" title="lihat dokumen" target="_blank"><i class="fa fa-eye fa-lg"></i></a>
                                    @endif
                                </td>
                                <td>
                                    @if($data->status == "1")
                            ...
                            <div class="modal fade view_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['lppm-kinerja-iptek.show', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                            @include('lppm.kinerja_luaran.iptek.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{action('KinerjaIptekController@destroy', $data['id'])}}" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade update_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['kinerja-iptek.update', $data->id], 'method'=>'PUT','files'=> true])}}
                                                @include('admin.kinerja_luaran.iptek.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
