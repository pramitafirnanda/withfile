        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Pemakalah Forum Ilmiah</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            {{ Form::open(['method' => 'post', 'route' => 'kinerja-forum.store', 'class' => 'form-horizontal', 'files'=> true]) }}
                                @include('admin.kinerja_luaran.forum_ilmiah.form')
                            {{ Form::close() }}
                        </div>
                    </div><!-- /.modal-content -->
                </div><!-- /.modal-dialog -->
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <h4 class="m-t-0 header-title"><b>Pemakalah Forum Ilmiah</b></h4>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        <a href="{{ asset('file_dokumen/kinerja/forum-ilmiah/'.$data->dokumen) }}" title="lihat dokumen" target="_blank"><i class="fa fa-eye fa-lg"></i></a>
                                    @endif
                                </td>
                                <td>
                                    @if($data->status == "1")
                            ...
                            <div class="modal fade view_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['lppm-kinerja-forum.show', $data->id], 'method'=>'PUT', 'files'=> true])}}
                                            @include('lppm.kinerja_luaran.forum_ilmiah.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-dialog modal-sm">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <form action="{{action('KinerjaForumController@destroy', $data['id'])}}" method="post">
                                                {{csrf_field()}}
                            ...
                            <div class="modal fade update_{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static" style="display: none;">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            {{Form::model($data,['route'=> ['kinerja-forum.update', $data->id], 'method'=>'PUT','files'=> true])}}
                                                @include('admin.kinerja_luaran.forum_ilmiah.form')
                                            {{ Form::close() }}
                                        </div>
                                    </div>
