<div class="form-group row">
    ...
    <label class="col-9 col-form-label"><strong>{{$data->isbn}}</strong></label>

    <label class="col-3 col-form-label">Jumlah Halaman:</label>
    <label class="col-9 col-form-label"><strong>{{$data->jumlah_halaman}}</strong></label>

    <label class="col-3 col-form-label">Penerbit:</label>
    <label class="col-9 col-form-label"><strong>{{$data->penerbit}}</strong></label>
