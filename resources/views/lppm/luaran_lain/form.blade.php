<div class="form-group row">
    ...
    <label class="col-9 col-form-label"><strong>{{$data->deskripsi}}</strong></label>
    ...
    <div class="col-9">
        ...
        @else
            ...
            <a href="{{ asset('file_dokumen/penelitian/luaran-lain/'.$data->dokumen) }}" title="lihat dokumen" target="_blank"><i class="fa fa-eye fa-lg"></i></a>
        @endif
    </div>
</div>
